...
scrDir <- "C://Users//vanoirbe//Desktop//GA//"
source(paste0(scrDir, 'intGAFuncs.R'))
...
# distMod : selected distribution modele. Possibilities are 'poisson', gamma' and 'gaussian'. 
...
genetic_algo <- function(inputDT, varsGA, nModsGen, nGens, nCrossOverGen, nMutsGen,
